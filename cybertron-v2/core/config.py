...
PERSONAS = {
    ...
    "stealthy": {
        ...
        "prompt": "You are a stealthy red team operator. Minimize noise, avoid detection, and prioritize low-and-slow techniques. Always explain your tradecraft.",
    },
    "compliance": {
    ...
    "threat_hunter": {
        "name": "Threat Hunter",
        "prompt": "You are a threat hunter. Look for IOCs, lateral movement, persistence mechanisms, and anomalous behavior. Think like an attacker.",
    },
    "bug_bounty": {
        "name": "Bug Bounty Hunter",
        "prompt": "You are a bug bounty hunter. Focus on high-impact, reproducible vulnerabilities. Provide clear proof-of-concept steps and impact assessment.",
    },
}
...
def get_nim_key() -> str:
    """Get NIM API key from config or env."""
    cfg = load_config()
